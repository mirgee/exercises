...
silent only
silent tabonly
cd ~/Source/tutorials/js/node-the-right-way/filesystem
...
%argdel
$argadd watcher.js
edit ~/Source/tutorials/js/node-the-right-way/microservices/zmq-watcher-pub.js
...
setlocal statusline=%{lightline#link()}%#LightlineLeft_inactive_0#%(\ %{lightline#mode()}\ %)%{(&paste)?\"|\":\"\"}%(\ %{&paste?\"PASTE\":\"\"}\ %)%#LightlineLeft_inactive_0_1#%#LightlineLeft_inactive_1#%(\ %f\ %)%{(&modified||!&modifiable)?\"|\":\"\"}%(\ %M\ %)%#LightlineLeft_inactive_1_2#%#LightlineMiddle_inactive#%=
...
wincmd w
argglobal
if bufexists("~/Source/tutorials/js/node-the-right-way/microservices/zmq-watcher-sub.js") | buffer ~/Source/tutorials/js/node-the-right-way/microservices/zmq-watcher-sub.js | else | edit ~/Source/tutorials/js/node-the-right-way/microservices/zmq-watcher-sub.js | endif
let s:cpo_save=&cpo
set cpo&vim
nmap <buffer> [c <Plug>GitGutterPrevHunk
nmap <buffer> \hp <Plug>GitGutterPreviewHunk
...
exe 'vert 2resize ' . ((&columns * 1 + 40) / 80)
tabnext 1
badd +19 ~/Source/tutorials/js/node-the-right-way/microservices/zmq-watcher-pub.js
badd +143 ~/.cache/typescript/3.5/node_modules/@types/zeromq/index.d.ts
badd +13 ~/Source/tutorials/js/node-the-right-way/networking/net-watcher.js
badd +1 .session.vim
badd +3 watcher.js
badd +13 watcher-spawn-parse.js
badd +3 cat.js
badd +8 write-simple.js
badd +1 target.txt
badd +1 read-simple.js
badd +7 watcher-argv.js
badd +12 watcher-spawn.js
badd +176 ~/.cache/typescript/3.5/node_modules/@types/node/globals.d.ts
badd +1 watcher-spawn-parse.jse
badd +1 read-stream.js
badd +1 ~/Source/tutorials/js/node-the-right-way/microservices/zmq-watcher-sub.js
