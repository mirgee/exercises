...
silent only
silent tabonly
cd ~/Source/tutorials/js/node-the-right-way/networking
...
normal! 0106|
tabnext 1
badd +10 net-watcher.js
badd +20 lib/ldj-client.js
badd +14 net-watcher-client.js
badd +23 test-json-service.js
